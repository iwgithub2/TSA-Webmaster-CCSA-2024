...
export default function Blog() {
    return(
        <main className="relative min-h-screen flex  bg-gradient-to-t from-forestgreen to-cream bg-opacity-10">
            <div className="flex flex-col mt-40 w-full lg:mx-20 px-5 sm:px-10 md:px-10">
                ...
                <p className={`${dmSans.className} font-medium text-yellow-950 text-center mb-5 lg:text-2xl md:text-xl sm:text-lg text-md mt-4 mx-5 font-serif tracking-tight`}>
